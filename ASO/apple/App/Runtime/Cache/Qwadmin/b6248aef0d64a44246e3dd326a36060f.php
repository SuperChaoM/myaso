...
<table class="table table-striped table-bordered table-hover">
    ...
    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$d): $mod = ($i % 2 );++$i;?><tr>
            ...
            <!-- <td><a href="https://aso100.com/app/keyword/appid/<?php echo ($d['app_id']); ?>/country/cn" target="_blank" > <?php echo ($d['app_id']); ?> </a></td> -->
            ...
            <td>
                <a class="btn btn-sm btn-success " href="<?php echo U('index',['app_id'=>$d['app_id']]);?>">查看子任务</a>
            </td>
