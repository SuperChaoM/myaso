...
<table class="table table-striped table-bordered">
    <thead>
    <tr><th style="width:80px;">序号</th>
        <th class="col-xs-4">变量说明</th>
        <th class="col-xs-1">变量名称</th>
        <th class="col-xs-3">调用说明</th>
        <th class="col-xs-1">变量值</th>
    ...
    <?php if(is_array($vars)): $i = 0; $__LIST__ = $vars;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><tr>
            ...
            <td><a href="<?php echo U('edit');?>&k=<?php echo ($val['k']); ?>"><i
                    class="ace-icon fa fa-pencil bigger-100"></i>修改</a>&nbsp&nbsp;<a
                    href="javascript:;" val="<?php echo U('del');?>&k=<?php echo ($val['k']); ?>" class="dellink"><i
