...
<!-- PAGE CONTENT BEGINS -->
	...
	<div class="space-4"></div>
		...
		<div class="form-group">
			...
			<div class="col-sm-9">
				<input type="number" name="app_id" class="rcol-xs-10 col-sm-5" value="<?php echo ($vo["app_id"]); ?>" placeholder="app_id">
				<a href="https://aso100.com/" target="_blank" style="margin-left: 50px;">app_id查找</a>
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-9">
				<input type="text" name="app_name" class="rcol-xs-10 col-sm-5" value="app_name" placeholder="app_name">
			</div>
		</div>
		...
		<div class="form-group" style="display: none">
			...
			<div class="col-sm-9">
				<input type="number" name="down_num" class="rcol-xs-10 col-sm-5" value="0" placeholder="成功数量">
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-9">
				<input type="text" name="keyword" class="rcol-xs-10 col-sm-5" value="<?php echo ($vo["keyword"]); ?>" placeholder="关键词，一个个子任务逗号隔开">
			</div>
		</div>
