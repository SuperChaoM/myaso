...
<!-- PAGE CONTENT BEGINS -->
	<form class="form-horizontal" id="form" role="form" method="post" action="<?php echo U('update');?>">
		<div class="form-group">
			<label class="col-sm-1 control-label no-padding-right" for="form-field-1"> 温馨提示 </label>
			<div class="col-sm-9">
				<textarea name="notice" id="notice" placeholder="温馨提示" class="col-xs-10 col-sm-5" rows="5"><?php echo (C("notice")); ?></textarea>
			<span class="help-inline col-xs-12 col-sm-7">
				<span class="middle">网站标题，前台调用：{$Think.CONFIG.notice}</span>
			</span>
			</div>
		</div>
