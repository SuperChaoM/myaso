	...
	<div class="container-fluid">
		<div class="row" style="margin-bottom: 1rem;">
			<div class="col-xs-4 col-sm-2">
				<input type="hidden" name="tpl_id" value="<?php echo ($vo['tpl_id']); ?>">
		...
		<div class="row" style="margin-bottom: 1rem;   ">
			<input type="text" name="tpl_name" value="<?php echo ($vo['tpl_name']); ?>" placeholder="模板名称" style="width: 70%; margin-left: 12px;"
			>
		</div>
